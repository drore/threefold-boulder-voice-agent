...
| R6 | Evaluation/testing setup | Runnable commands, versioned cases/results, and meaningful failures cover R1–R5. Application, provider, model, and voice verification are distinguished. | 162 local DB tests pass; six opt-in live intent cases passed and two capability cases added awaiting a paid rerun; credential-free CI workflow prepared but not run remotely; spoken and delivery evidence pending |
