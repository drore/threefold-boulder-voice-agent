...
| --- | --- | --- | --- |
| V0 | Voice agent for a US city | Fresh reviewer speaks/hears relevant responses through the delivered link; Boulder and demo limitations are clear. | Deployed link supports a fresh reviewer's spoken run (browser WebRTC + client delegation); no recorded sample in-repo |
