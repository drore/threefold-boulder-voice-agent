...
| --- | --- | --- | --- |
| V0 | Voice agent for a US city | Fresh reviewer speaks/hears relevant responses through the delivered link; Boulder and demo limitations are clear. | Browser WebRTC and client delegation implemented/tested with fakes; Dror personally used the live spoken browser path on 2026-09-16 with a positive report; formal recorded/deployed voice proof pending |
...
| R3 | Open a ticket in a selected platform | Confirmed spoken report creates a real Linear issue in the approved demo project; a real API readback verifies ID and fields. | Live closed-hours creation passed 2026-09-16: issue DRO-5 created and independently read back with matching team/project/title/description; spoken trigger pending |
