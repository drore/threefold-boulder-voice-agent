...
- Preserve frontmatter and the eleven numbered sections. Keep authoritative shared types in the architecture/workflow/integration specifications; reference them instead of creating conflicting definitions.
